...
key = key_secret.key  # Flickr API key https://www.flickr.com/services/apps/create/apply
secret = key_secret.secret
url_txt = open('url_txt.txt','w')
...
def get_urls(search='honeybees on flowers', n=10, download=False):
    ...
    if download:
        dir = os.getcwd() + os.sep + 'bilder' + os.sep + search.replace(' ', '_') + os.sep  # save directory
